...
# Основний логер
def log_user_action(user_id: int, username: Optional[str], action: str, details: Optional[str] = None):
...
def log_parsing_action(user_id: int, action: str, details: Optional[str] = None, url: Optional[str] = None):
    """Логує дії парсингу"""
...
def log_parsing_step(user_id: int, step: str, details: Optional[str] = None, count: Optional[int] = None):
