...
async def about_us(message: Message):
    ...
    await message.answer(
        """Вітаю! Я студент фахового коледжу інформаційних технологій Націольного Університету "Львівська Політехніка", першокурсник. Ця програма створена 1 людиною без використання ChatGPT для прямого написання\
 коду
